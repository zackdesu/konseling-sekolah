...
const Menu = () => {
  return (
    <div className="mx-auto fixed bottom-5 left-0 right-0 max-w-[250px] w-[55%] min-[500px]:w-[40%] md:w-1/3">
      <div className="bg-zinc-200 px-8 py-3 flex justify-between items-center rounded-full relative z-30">
        <Link to={"/"}>
